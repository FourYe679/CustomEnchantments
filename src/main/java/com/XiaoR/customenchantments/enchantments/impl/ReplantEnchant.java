...
public class ReplantEnchant extends CustomEnchantment {
    public ReplantEnchant() {
        super("replant");
    }
    ...
    @Override
    public void onBowShoot(Player player, org.bukkit.entity.Arrow arrow, int level, ItemStack item) {
    }
}
